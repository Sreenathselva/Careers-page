          ...
          <ContactCont>
            ...
            <Cboxes>
              <Cbox>
                <CLeft>
                  <CIcon>
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink"  x="0" y="0" viewBox="0 0 368.16 368.16" style={{ enableBackground: "new 0 0 512 512" }} xmlSpace="preserve" class=""><g><path d="M184.08 0c-74.992 0-136 61.008-136 136 0 24.688 11.072 51.24 11.536 52.36 3.576 8.488 10.632 21.672 15.72 29.4l93.248 141.288c3.816 5.792 9.464 9.112 15.496 9.112s11.68-3.32 15.496-9.104l93.256-141.296c5.096-7.728 12.144-20.912 15.72-29.4.464-1.112 11.528-27.664 11.528-52.36 0-74.992-61.008-136-136-136zM293.8 182.152c-3.192 7.608-9.76 19.872-14.328 26.8l-93.256 141.296c-1.84 2.792-2.424 2.792-4.264 0L88.696 208.952c-4.568-6.928-11.136-19.2-14.328-26.808-.136-.328-10.288-24.768-10.288-46.144 0-66.168 53.832-120 120-120s120 53.832 120 120c0 21.408-10.176 45.912-10.28 46.152z"  opacity="1" data-original="#000000" class=""></path><path d="M184.08 64.008c-39.704 0-72 32.304-72 72s32.296 72 72 72 72-32.304 72-72-32.296-72-72-72zm0 128c-30.872 0-56-25.12-56-56s25.128-56 56-56 56 25.12 56 56-25.128 56-56 56z"  opacity="1" data-original="#000000" class=""></path></g></svg>
                  </CIcon>
                </CLeft>
                <CRight>
                  <div className="sub-head">Head Office</div>
                  <div className="sub-point">#32, Chinmaya Mission Hospital Road, Indiranagar II Stage, Bangalore – 560 038, India</div>
                </CRight>
              </Cbox>
              <Cbox>
                <CLeft>
                  <CIcon>
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 512 512" style={{ enableBackground: "new 0 0 512 512" }} xmlSpace="preserve" class=""><g><path d="M467 76H45C20.137 76 0 96.262 0 121v270c0 24.885 20.285 45 45 45h422c24.655 0 45-20.03 45-45V121c0-24.694-20.057-45-45-45zm-6.302 30L287.82 277.967c-8.5 8.5-19.8 13.18-31.82 13.18s-23.32-4.681-31.848-13.208L51.302 106h409.396zM30 384.894V127.125L159.638 256.08 30 384.894zM51.321 406l129.587-128.763 22.059 21.943c14.166 14.166 33 21.967 53.033 21.967s38.867-7.801 53.005-21.939l22.087-21.971L460.679 406H51.321zM482 384.894 352.362 256.08 482 127.125v257.769z"  opacity="1" data-original="#000000" class=""></path></g></svg>
                  </CIcon>
                </CLeft>
                <CRight>
              ...
              <FollowBox>
                <div className="follow-sub-head">
                Follow our social media
                </div>
                <div className="follow-icons">
                  <div className="follow-icon"><i class="fa-brands fa-facebook-f"></i></div>
                  <div className="follow-icon"><i class="fa-brands fa-instagram"></i></div>
                  <div className="follow-icon"><i class="fa-brands fa-x-twitter"></i></div>
                  <div className="follow-icon"><i class="fa-brands fa-youtube"></i></div>
                  <div className="follow-icon"><i class="fa-brands fa-linkedin-in"></i></div>
                </div>
              </FollowBox>
            </Cboxes>
          </ContactCont>
